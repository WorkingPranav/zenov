...
async def handle_file(
    ...
    temp_message = await file_message.reply_text(
        f"<b>‼️ Before Downloading the Episode(s), Forward them to Saved Messages or Another Chat, here they'll be Deleted in {human_readable_time(message_delete_time)} ‼️\n\n❖ Support Group: @ParadoxChats</b>"
    )
